      ...
      <script dangerouslySetInnerHTML={{__html:`
        ...
        function renderHistory() {
          ...
          c.innerHTML = scanHistory.map(e => {
            ...
            return '<div class="history-item" onclick="toggleExpand(\''+e.id+'\')">'
        ...
        async function renderAdminPage() {
          try {
            ...
            tbody.innerHTML = users.map(u=>{
              ...
              const actions = isMe?'<span style="font-size:10px;color:var(--text3)">YOU</span>':
                '<button class="tbl-action tbl-promote" onclick="promoteUser(\''+u.id+'\',\''+u.role+'\')">↑ Promote</button> <button class="tbl-action" onclick="deleteUser(\''+u.id+'\')">✕ Remove</button>';
