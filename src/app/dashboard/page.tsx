    ...
    <>
      ...
      <script dangerouslySetInnerHTML={{__html:`
        ...
        function setupScan() {
          ...
          document.getElementById('username-input').addEventListener('keydown', e => { if(e.key==='Enter') startScan(); });
        }
        ...
        function setupAutomation() {
          ...
          document.getElementById('import-textarea').oninput = updateImportCount;
          document.getElementById('import-run-btn').onclick = runImportList;
        }
        ...
        // FIX: toggleExpand called via data-id to avoid escaped-quote syntax errors
        ...
        function renderHistory() {
          ...
          c.innerHTML = scanHistory.map(e => {
            ...
            // FIX: data-id + this.dataset.id instead of escaped inline string arg
        ...
        async function renderAdminPage() {
          try {
            ...
            // FIX: data-id + data-role on buttons instead of escaped inline string args
            tbody.innerHTML = users.map(u=>{
              ...
              const actions = isMe
                ...
                : '<button class="tbl-action tbl-promote" data-id="'+u.id+'" data-role="'+u.role+'" onclick="promoteUser(this.dataset.id,this.dataset.role)">↑ Promote</button> <button class="tbl-action" data-id="'+u.id+'" onclick="deleteUser(this.dataset.id)">✕ Remove</button>';
